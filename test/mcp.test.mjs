...
test('MCP handshake, tools and scoped API errors', async () => {
  ...
  try {
    ...
    for (const name of ['nexode_me', 'nexode_plans', 'nexode_repositories', 'nexode_compute_create', 'nexode_compute_deploy_status', 'nexode_compute_set_env', 'nexode_compute_link_database', 'nexode_n8n_restart']) {
